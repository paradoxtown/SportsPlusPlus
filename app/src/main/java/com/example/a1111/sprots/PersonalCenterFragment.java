...
public class PersonalCenterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView ballIco = view.findViewById(R.id.ball_ico);
        ImageView keyIco = view.findViewById(R.id.key_ico);
        userName.setText("paradox");
        userName.setTextSize(36);
        description.setText("test,test,test,test");
        attentionTeamText.setTextSize(16);
        // attentionTeamText.setTextColor(Color.WHITE);
        // attentionTeamText.setBackgroundColor(Color.BLACK);
        modifyPwText.setTextSize(16);
        // modifyPwText.setTextColor(Color.WHITE);
        // modifyPwText.setBackgroundColor(Color.BLACK);
        logoutText.setTextSize(16);
        // logoutText.setBackgroundColor(Color.BLACK);
        ...
        // ListAdapter listAdapter = attentionList.getAdapter();

//         setListViewHeightBasedOnChildren(attentionList);
