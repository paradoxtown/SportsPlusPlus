...
public class MatchActivity extends AppCompatActivity {
    private static JSONArray ret = null;
...
//        navigation.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);
        ...
        // getTeamSummary("156001");
        getPlayerSummary(id);
        RefreshLayout refreshLayout = (RefreshLayout)findViewById(R.id.container);
    ...
    private void getMatch(String id) {
        ...
        http.setListener(new Http.OnResponseListener<JSONArray>() {
            ...
            public void onResponse(JSONArray games) throws JSONException, IOException {
                ...
                // System.out.println(matchRet.toString());
            }
        });
        http.execute("GetMatch", id);
    }

//    private void getImage(final String describe) {
//        LoadImg<Bitmap> loadImg = new LoadImg<>();
//        loadImg.setListener(new LoadImg.OnResponseListener<Bitmap>() {
//            @Override
//            public void onResponse(Bitmap images) throws IOException {
//                imgRet = images;
//                if (describe.equals(home_team)) {
//                    MatchActivity.this.setHomeImageView(imgRet);
//                }
//                else {
//                    MatchActivity.this.setAwayImageView(imgRet);
//                }
//            }
//        });
//        loadImg.execute("GetTeamImage", describe);
//    }
...
//            away_team = team1.getString("主客场");
//            home_team = team2.getString("主客场");
//            setTextView(team1.getString("得分"), team2.getString("得分"));
//        }
//        else {
//            away_team = team2.getString("主客场");
//            home_team = team1.getString("主客场");
//            setTextView(team2.getString("得分"), team1.getString("得分"));
//        }
...
//    private void setHomeImageView(Bitmap homeImg) throws IOException {
//        ImageView image_home = findViewById(R.id.imageView_home);
//        image_home.setImageBitmap(homeImg);
////        ImageView image_away = findViewById(R.id.imageView_away);
////        image_home.setImageResource(R.drawable.celtics);
////        image_away.setImageResource(R.drawable.sixers);
////        URL home_img_url = new URL("http://114.116.156.240/api/GetTeamImage/" + home_team);
////        URL away_img_url = new URL("http://114.116.156.240/api/GetTeamImage/" + away_team);
////        Bitmap home_img_bit = BitmapFactory.decodeStream(home_img_url.openConnection().getInputStream());
////        Bitmap away_img_bit = BitmapFactory.decodeStream(away_img_url.openConnection().getInputStream());
////        image_home.setImageBitmap(home_img_bit);
////        image_away.setImageBitmap(away_img_bit);
//    }
//
//    private void setAwayImageView(Bitmap awayImg) {
//        ImageView image_away = findViewById(R.id.imageView_away);
//        image_away.setImageBitmap(awayImg);
//    }

    private List<GameItem> setSumList() throws JSONException {
        List<GameItem> list = new ArrayList<>();
//        list.add(new GameItem("76人", "21", "21", "24", "21", "87"));
//        list.add(new GameItem("凯尔特人", "21", "26", "30", "28", "105"));
    ...
    private void setSumTableConfig() throws JSONException {
        ...
        //table_sum.getConfig().setMinTableWidth(screenWith);
    }
